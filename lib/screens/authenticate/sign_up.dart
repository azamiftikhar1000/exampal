      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: GestureDetector(
              ...
              child: Icon(Icons.add_a_photo, size: _large? 40: (_medium? 33: 31),color: Colors.blue,)),
        ),
//        Positioned(
//          top: _height/8,
//          left: _width/1.75,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          GestureDetector(
            onTap: () {
              Navigator.of(context).pop(SigninRoute);
              print("Routing to Sign up screen");
            },
            child: Text(
              "Sign in",
              style: TextStyle(
                  fontWeight: FontWeight.w800, color: Colors.blue, fontSize: 19),
            ),
          )
        ],
      ),
